...
type CountryRecord = readonly [name: string, code: string, dialCode: string];

const countryRecords: readonly CountryRecord[] = [
  ["Afghanistan","AF","+93"],
...
export const countries: Country[] = countryRecords.map(([name, code, dialCode]) => ({
  code,
