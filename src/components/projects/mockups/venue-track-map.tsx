...
import {
  ...
  TrackDots,
  type DotLap,
} from "@/components/projects/mockups/track-dots";
...
export function VenueTrackMap({
  ...
  return (
    <div className="relative h-32 w-full overflow-visible text-accent sm:h-36">
      <AnimatePresence mode="wait">
        ...
        >
          <p className="pointer-events-none absolute left-3 top-1 font-display text-[2.75rem] leading-[0.8] text-foreground/12 sm:text-[3.25rem]">
            {track.watermark}
          </p>
