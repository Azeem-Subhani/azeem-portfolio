...
export function Hero() {
  ...
  return (
    <section
      ...
      className="relative isolate overflow-x-hidden min-h-[calc(100svh-5rem)]"
    >
      <div
        aria-hidden="true"
        className="graph-paper graph-field absolute inset-0 hidden lg:block"
      />
      ...
      <div className="relative mx-auto grid max-w-7xl items-center gap-12 px-6 py-20 lg:grid-cols-[1.1fr_0.9fr]">
        <div className="max-w-4xl">
          ...
          <h1
            ref={titleRef}
            id="hero-title"
            className="text-balance font-display text-[clamp(3rem,7vw,7rem)] font-normal leading-[0.98]"
          >
            {profile.title}
          </h1>
        ...
        <div ref={mapRef} className="relative isolate lg:justify-self-end">
          <div
            aria-hidden="true"
