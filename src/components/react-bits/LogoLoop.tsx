...
function isNodeLogoItem(item: LogoItem): item is NodeLogoItem {
  return 'node' in item;
}
...
const useResizeObserver = (
  ...
  // The caller owns this hook's dependency contract because callback and ref
  // identities are intentionally paired with the measured element set.
...
const useImageLoader = (
  ...
  // The caller owns this hook's dependency contract because the image set is
  // tied to the same sequence dependencies used by the resize observer.
  // eslint-disable-next-line react-hooks/exhaustive-deps
  }, dependencies);
};
    ...
    const rootClasses = useMemo(
      () =>
        cx(
          ...
          '[--logoloop-fadeColorAuto:#fdf6e3]',
          'dark:[--logoloop-fadeColorAuto:#002b36]',
